...
def index(request):
    ...
    return render(request,'prac/index.html',{'question':random.choice(question_list)})
...
def choose(request, question_id):
    ...
    return render(request,'prac/choose.html',{'question':question,'choice1':choice_list[0],'choice2':choice_list[1]})
...
def vote(request, question_id):
    ...
    try:
        ...
        return render(request, 'prac/choose.html',{'question':question,'error_message': "You didn't select a choice"})
    else:
        selected_choice.results += 1
        selected_choice.save()
        return HttpResponseRedirect(reverse('prac:results',args=(question.id,)))
